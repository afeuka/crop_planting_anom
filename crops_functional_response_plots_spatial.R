...
#load beta table --------------
beta_tab<- read.csv("C:/Users/Abigail.Feuka/OneDrive - USDA/Feral Hogs/Crops/Model outputs/Spatial/Plots/Combined Figures/op_betas_all_table.csv")
...
ggsave(filename=paste0(model_dir,"/Model outputs/",subfolder,"/Plots/Combined Figures/.jpeg"),
